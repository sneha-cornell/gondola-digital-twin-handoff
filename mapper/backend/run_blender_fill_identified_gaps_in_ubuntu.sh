...
BLEND_IN="workspace/iphone16-2_named_high_recall_v4_job/shelf_22-2_single_best_image_layout_identified.blend"
IDENTIFIED_JSON="workspace/iphone16-2_named_high_recall_v4_job/blender_single_best_image_layout_identified.json"
BLEND_OUT="/app/backend/workspace/iphone16-2_named_high_recall_v4_job/shelf_22-2_single_best_image_layout_filled.blend"

/tmp/blender-5.1.2-stable+v51.ec6e62d40fa9-linux.x86_64-release/blender \
  "$BLEND_IN" \
  --background \
  --python blender_fill_identified_gaps.py \
  -- \
